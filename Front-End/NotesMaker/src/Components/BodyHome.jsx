          ...
          <div>
            {id && (
              <p className="mt-2 font-heading break-all">
                <p className = 'text-primtext font-bold'>This is your link:</p> <Link to={`https://paste-it-jade.vercel.app/FindNote/${id}`} className = 'text-sectext'> 
                  https://paste-it-jade.vercel.app/FindNote/{id}
                </Link>
              </p>
            )}
          </div>
